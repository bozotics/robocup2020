	...
	while ((millis() - timeStart) < timeout)
	{
		...
		if (Serial1.available())
		{
			if (Serial1.read() == 'L')
			{
				...
				int lightThresManual[40] = {334,289,322,260,246,231,257,285,255,284,257,240,251,242,292,302,268,287,306,312,356,235,231,266,289,354,368,292,234,261,263,239,294,298,320,306,149,156,900,900};
				for (int i = 0; i < 40; i++)
				{
